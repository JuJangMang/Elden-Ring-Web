...
const KeyFeatures = () => (
  <div className="app__keyfeatures app__bg app__wrapper section__padding" id="keyfeatures">
    <div className="app__wrapper_info">
      <h1 className="app__keyfeatures_head headtext__cormorant flex__center">Key Features</h1>
      <div className="app__keyfeatures-1">
        <div className="app__wrapper_info">
          ...
          Unravel the mysteries of the Elden Ring’s power. Encounter adversaries with profound backgrounds, characters with their own unique motivations for helping or hindering your progress, and fearsome creatures. </p>
        </div>
        <div className="app__wrapper_img">
          <img src={images.world} alt="world" />
        </div>
      </div>
      <div className="app__keyfeatures-2">        
        <div className="app__wrapper_img2">
          <img src={images.explore} alt="explore" />
        </div>                  
        <div className="app__keyfeatures-container">
